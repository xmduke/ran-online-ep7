...
// 극강부 추가
#if defined(KRT_PARAM) || defined(KR_PARAM) || defined(TW_PARAM) || defined( TH_PARAM ) || defined ( HK_PARAM ) || defined ( MYE_PARAM ) || defined ( MY_PARAM ) || defined ( CH_PARAM ) || defined ( PH_PARAM ) || defined ( JP_PARAM )
	{
