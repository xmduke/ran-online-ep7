...
#ifdef USE_GMAX_SECURITY // gmax disables certain maxscript calls for data security
#define notSupportedByGMAX(fn)	\
    throw RuntimeError (_T("Feature not available for gmax: "), _T(#fn)); 
#endif
