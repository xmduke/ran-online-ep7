...
// #include "buildver.h"        // For product-specific stuff like MAXVER_PRODUCTNAME
							//but I don't know why this isn't in this file here, for easy overriding.... WS
...
#define MAXVER_LEGALTRADEMARKS	"Discreet, Autodesk, Inc., Kinetix, 3D Studio MAX, 3D Studio VIZ, Biped, Character Studio, Heidi, Kinetix, Physique, 3ds max, DWG Unplugged, FLI, FLIC, and DXF are either registered trademarks or trademarks of Discreet Logic Inc./Autodesk, Inc.\0"
#endif
...
#define MAXVER_RCVERSION					_MAXVER_RCVERSION(MAX_VERSION_MAJOR, MAX_VERSION_MINOR, MAX_VERSION_POINT, VERSION_INT)
#define MAXVER_RCVERSION_STR				_MAXVER_RCVERSION_STR(MAX_VERSION_MAJOR, MAX_VERSION_MINOR, MAX_VERSION_POINT, VERSION_INT)
...
VS_VERSION_INFO VERSIONINFO
 FILEVERSION MAXVER_RCVERSION
 PRODUCTVERSION MAXVER_RCVERSION
 FILEFLAGSMASK 0x3fL
#ifdef _DEBUG
 FILEFLAGS 0x1L
#else
...
BEGIN
    ...
    BEGIN
        ...
        BEGIN
            ...
            VALUE "FileVersion", MAXVER_RCVERSION_STR
            ...
            VALUE "ProductVersion", MAXVER_RCVERSION_STR
