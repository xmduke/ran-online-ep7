// SoundSourceManager.cpp : 응용 프로그램에 대한 클래스 동작을 정의합니다.
//
...
// 유일한 CSoundSourceManagerApp 개체입니다.

CSoundSourceManagerApp theApp;

// CSoundSourceManagerApp 초기화
...
// CSoundSourceManagerApp 메시지 처리기
